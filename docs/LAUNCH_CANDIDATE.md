...
| 6. Adversarial + live proof | PARTIAL | adversarial suites green (confidential 1943 tests collected; subnet two-mode 24 incl. work-replay, derived-challenge, and fence counterexamples); LIVE mainnet proof NOT PROVEN (deploy blocked) |
