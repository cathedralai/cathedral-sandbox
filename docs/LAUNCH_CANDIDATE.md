...
| 6. Adversarial + live proof | PARTIAL | adversarial suites green (confidential 1925 tests collected; subnet two-mode 24 incl. work-replay, derived-challenge, and fence counterexamples); LIVE mainnet proof NOT PROVEN (deploy blocked) |
